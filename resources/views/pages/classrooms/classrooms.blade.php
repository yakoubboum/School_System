    ...
    <div class="col-xl-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form action="/classrooms/filter" method="POST">
                    {{ csrf_field() }}
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            ...
                                                            <input id="Name" type="text" name="Name"
                                                                class="form-control"
                                                                value="{{ $My_Class->getTranslation('classname', 'ar') }}"
                                                                required>
                                                        ...
                                                        <div class="col">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="{{ $My_Class->getTranslation('classname', 'en') }}"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class=" row mb-30" action="/classrooms/store" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="repeater">
