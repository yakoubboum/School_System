                                                            ...
                                                            <tbody>
                                                                ...
                                                                @foreach ($Grade->Sections as $list_Sections)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $list_Sections->My_classs->classname }}
                                                                        </td>
                                                                        <td>
                                                                                    ...
                                                                                    <form
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select name="Class_id"
                                                                                                ...
                                                                                                <option
                                                                                                    ...
                                                                                                    {{ $list_Sections->My_classs->classname }}
                                                                                                </option>
                                                                                            </select>
                                                                                        </div>
                                                                                        <br>
                                                                                        ...
                                                                                        <div class="col">
                                                                                            ...
                                                                                            <select multiple
                                                                                                ...
                                                                                                @if(!(\Illuminate\Support\Facades\DB::table('teacher_section')->where('teacher_id', $teacher->id)->first()))
                                                                                                    <option
                                                                                                        value="{{ $teacher->id }}">
                                                                                                        {{ $teacher->Name }}
                                                                                                    </option>
